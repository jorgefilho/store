...
import com.store.checkout.api.service.promotion.builder.PromotionBuilder;
import com.store.checkout.api.service.promotion.builder.ShoppingCartItemBuilder;
import com.store.checkout.api.session.domain.ShoppingCartItem;

@RunWith(JUnit4.class)
public class PriceDiscountRuleServiceTest {
	...
	private PriceDiscountRuleService ruleService = new PriceDiscountRuleService();

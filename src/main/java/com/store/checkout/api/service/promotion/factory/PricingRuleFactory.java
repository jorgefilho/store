package com.store.checkout.api.service.promotion.factory;
...
import com.store.checkout.api.service.promotion.RuleService;
...
public class PricingRuleFactory {
	...
	public List<ShoppingCartItem> apply(final Promotion promotion, final ShoppingCartItem shoppingCartItem) {
		...
		try{
			final RuleService service = (RuleService) context.getBean(promotion.getType().getBeanName());
			if (service == null) {
